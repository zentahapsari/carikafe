...
<html>
 ...
 <body>
  ...
  <div class="container box">
   <h3 align="center">Tabel Keranjang Reservasi Kafe</h3><br />
    ...
    <div class="panel-heading">
     <div class="row">
      ...
      <div class="col-md-4">
       ...
       <a href="{{ url('/postadmin/1') }}" class="btn btn-warning btn-sm" role="button" >Add</a>
       <a href="/sewakafe/export" class="btn btn-primary">Export ke Excel</a>
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    for(var count = 0; count < data.length; count++)
    {
     ...
     output += '<td>' + data[count].id_paket + '</td>';
     output += '<td>' + data[count].jumlah_orang + '</td>';
